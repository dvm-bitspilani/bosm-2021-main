function changeText() {
      ...
      if (
            document.getElementsByClassName("student")[0].value ===
            "School Student"
      ) {
            ...
            document.querySelector(
                  ".changeYear option:nth-child(2)"
            ).disabled = false;
            document.querySelector(
                  ".changeYear option:nth-child(3)"
            ).disabled = false;
            document.querySelector(
                  ".changeYear option:nth-child(4)"
            ).disabled = false;
            document.querySelector(
                  ".changeYear option:nth-child(5)"
            ).disabled = true;
            document.querySelector(
                  ".changeYear option:nth-child(6)"
            ).disabled = true;
            document.querySelector(
                  ".changeYear option:nth-child(7)"
            ).disabled = true;
            document.querySelector(
                  ".changeYear option:nth-child(8)"
            ).disabled = true;
            document.querySelector(
                  ".changeYear option:nth-child(9)"
            ).disabled = true;
      } else if (
            ...
            document.getElementsByClassName("studyYear")[0].innerHTML =
                  "Year of Study";
            document.getElementById("hideGrad").style.display = "initial";
            document.querySelector(
                  ".changeYear option:nth-child(1)"
            ).innerHTML = "Year of Study";
            document.querySelector(
                  ".changeYear option:nth-child(2)"
            ).disabled = true;
            document.querySelector(
...
function getsportsvalue() {
      ...
      const sports_id =
            document.getElementById("sports_opt")[
      ...
      div.onclick = function () {
            ...
            for (var i = 0; i < no_of_sports; i++) {
                  if (
                        x[0].innerHTML ==
                        document.getElementsByClassName("sports-tag")[i]
                              .innerHTML
                  ) {
                        document.getElementsByClassName("sports-tag")[
                              i
                        ].disabled = false;
...
function bosmreg() {
      if (document.getElementById("no").checked) {
            ...
            if (
                  ...
                  fetch(
                        "https://bits-bosm.org/bosm2021/registrations/register/",
                        {
                              method: "PUT",
                              body: aadharFormData,
                        }
